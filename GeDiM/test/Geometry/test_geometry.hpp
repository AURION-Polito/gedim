...
namespace GedimUnitTesting
{
  ...
  TEST(TestGeometryUtilities, TestPolarAngle)
  {
    ...
    ASSERT_DOUBLE_EQ(0.0,
                     geometryUtilities.AngleRadiansToDegree(0.0));
    ASSERT_DOUBLE_EQ(0.0,
                     geometryUtilities.AngleDegreeToRadians(0.0));
    ASSERT_DOUBLE_EQ(90.0,
                     geometryUtilities.AngleRadiansToDegree(std::numbers::pi / 2.0));
    ASSERT_DOUBLE_EQ(std::numbers::pi / 2.0,
                     geometryUtilities.AngleDegreeToRadians(90.0));
    ASSERT_DOUBLE_EQ(180.0,
                     geometryUtilities.AngleRadiansToDegree(std::numbers::pi));
    ASSERT_DOUBLE_EQ(std::numbers::pi,
                     geometryUtilities.AngleDegreeToRadians(180.0));
    ASSERT_DOUBLE_EQ(-90.0,
                     geometryUtilities.AngleRadiansToDegree(-std::numbers::pi / 2.0));
    ASSERT_DOUBLE_EQ(-std::numbers::pi / 2.0,
                     geometryUtilities.AngleDegreeToRadians(-90.0));
