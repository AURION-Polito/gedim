...
TEST(TestGeometryUtilities, TestPolarAngle)
{
    ...
    ASSERT_DOUBLE_EQ(0.0, geometryUtilities.AngleRadiansToDegree(0.0));
    ASSERT_DOUBLE_EQ(0.0, geometryUtilities.AngleDegreeToRadians(0.0));
    ASSERT_DOUBLE_EQ(90.0, geometryUtilities.AngleRadiansToDegree(std::numbers::pi / 2.0));
    ASSERT_DOUBLE_EQ(std::numbers::pi / 2.0, geometryUtilities.AngleDegreeToRadians(90.0));
    ASSERT_DOUBLE_EQ(180.0, geometryUtilities.AngleRadiansToDegree(std::numbers::pi));
    ASSERT_DOUBLE_EQ(std::numbers::pi, geometryUtilities.AngleDegreeToRadians(180.0));
    ASSERT_DOUBLE_EQ(-90.0, geometryUtilities.AngleRadiansToDegree(-std::numbers::pi / 2.0));
    ASSERT_DOUBLE_EQ(-std::numbers::pi / 2.0, geometryUtilities.AngleDegreeToRadians(-90.0));
    ASSERT_DOUBLE_EQ(-180.0, geometryUtilities.AngleRadiansToDegree(-std::numbers::pi));
    ASSERT_DOUBLE_EQ(-std::numbers::pi, geometryUtilities.AngleDegreeToRadians(-180.0));

    ASSERT_DOUBLE_EQ(45.0, geometryUtilities.AngleRadiansToDegree(std::numbers::pi / 4.0));
    ASSERT_DOUBLE_EQ(std::numbers::pi / 4.0, geometryUtilities.AngleDegreeToRadians(45.0));
    ASSERT_DOUBLE_EQ(30.0, geometryUtilities.AngleRadiansToDegree(std::numbers::pi / 6.0));
    ASSERT_DOUBLE_EQ(std::numbers::pi / 6.0, geometryUtilities.AngleDegreeToRadians(30.0));
    ASSERT_DOUBLE_EQ(60.0, geometryUtilities.AngleRadiansToDegree(std::numbers::pi / 3.0));
    ASSERT_DOUBLE_EQ(std::numbers::pi / 3.0, geometryUtilities.AngleDegreeToRadians(60.0));

    ASSERT_DOUBLE_EQ(135.0, geometryUtilities.AngleRadiansToDegree(std::numbers::pi / 4.0 + std::numbers::pi / 2.0));
    ASSERT_DOUBLE_EQ(std::numbers::pi / 4.0 + std::numbers::pi / 2.0, geometryUtilities.AngleDegreeToRadians(135.0));
    ASSERT_DOUBLE_EQ(120.0, geometryUtilities.AngleRadiansToDegree(std::numbers::pi / 6.0 + std::numbers::pi / 2.0));
    ASSERT_DOUBLE_EQ(std::numbers::pi / 6.0 + std::numbers::pi / 2.0, geometryUtilities.AngleDegreeToRadians(120.0));
    ASSERT_DOUBLE_EQ(150.0, geometryUtilities.AngleRadiansToDegree(std::numbers::pi / 3.0 + std::numbers::pi / 2.0));
    ASSERT_DOUBLE_EQ(std::numbers::pi / 3.0 + std::numbers::pi / 2.0, geometryUtilities.AngleDegreeToRadians(150.0));

    ASSERT_DOUBLE_EQ(-135.0, geometryUtilities.AngleRadiansToDegree(std::numbers::pi / 4.0 - std::numbers::pi));
    ASSERT_DOUBLE_EQ(std::numbers::pi / 4.0 - std::numbers::pi, geometryUtilities.AngleDegreeToRadians(-135.0));
    ASSERT_DOUBLE_EQ(-150.0, geometryUtilities.AngleRadiansToDegree(std::numbers::pi / 6.0 - std::numbers::pi));
    ASSERT_DOUBLE_EQ(std::numbers::pi / 6.0 - std::numbers::pi, geometryUtilities.AngleDegreeToRadians(-150.0));
    ASSERT_DOUBLE_EQ(-120.0, geometryUtilities.AngleRadiansToDegree(std::numbers::pi / 3.0 - std::numbers::pi));
    ASSERT_DOUBLE_EQ(std::numbers::pi / 3.0 - std::numbers::pi, geometryUtilities.AngleDegreeToRadians(-120.0));

    ASSERT_DOUBLE_EQ(-45.0, geometryUtilities.AngleRadiansToDegree(std::numbers::pi / 4.0 - std::numbers::pi / 2.0));
    ASSERT_DOUBLE_EQ(std::numbers::pi / 4.0 - std::numbers::pi / 2.0, geometryUtilities.AngleDegreeToRadians(-45.0));
    ASSERT_DOUBLE_EQ(-60.0, geometryUtilities.AngleRadiansToDegree(std::numbers::pi / 6.0 - std::numbers::pi / 2.0));
    ASSERT_DOUBLE_EQ(std::numbers::pi / 6.0 - std::numbers::pi / 2.0, geometryUtilities.AngleDegreeToRadians(-60.0));
    ASSERT_DOUBLE_EQ(-30.0, geometryUtilities.AngleRadiansToDegree(std::numbers::pi / 3.0 - std::numbers::pi / 2.0));
    ASSERT_DOUBLE_EQ(std::numbers::pi / 3.0 - std::numbers::pi / 2.0, geometryUtilities.AngleDegreeToRadians(-30.0));
    ...
    ASSERT_DOUBLE_EQ(-std::numbers::pi / 2.0,
    ...
    ASSERT_DOUBLE_EQ(+std::numbers::pi,
                     geometryUtilities.Angle(Eigen::Vector3d(0.0, 0.0, 0.0),
                                             Eigen::Vector3d(0.5, 0.0, 0.0),
                                             Eigen::Vector3d(1.0, 0.0, 0.0),
                                             (Eigen::Vector3d(0.0, 0.0, 0.0) - Eigen::Vector3d(0.5, 0.0, 0.0)).norm(),
...
{
    std::string exportFolder = "./Export/TestGeometryUtilities/TestPlaneReflectionMatrix";
    ...
    {
        Eigen::MatrixXd polyhedron_points(3, 12);
        polyhedron_points.col(0) << 3.5, 1.5, 0.0;
        polyhedron_points.col(1) << 5.5, 1.5, 0.0;
        polyhedron_points.col(2) << 5.5, 4.5, 0.0;
        polyhedron_points.col(3) << 3.5, 4.5, 0.0;
        polyhedron_points.col(4) << 3.5, 1.5, -1.5;
        polyhedron_points.col(5) << 5.5, 1.5, -1.5;
        polyhedron_points.col(6) << 5.5, 4.5, -1.5;
        polyhedron_points.col(7) << 3.5, 4.5, -1.5;
        polyhedron_points.col(8) << 4.0, 2.3, -1.5;
        polyhedron_points.col(9) << 5.0, 2.3, -1.5;
        polyhedron_points.col(10) << 5.0, 3.0, -1.5;
        polyhedron_points.col(11) << 4.0, 3.0, -1.5;

        const auto polyhedron = geometryUtilities.FacetsToPolyhedron(polyhedron_points,
                                                                     {{0, 1, 2, 3},
                                                                      {4, 7, 3, 0},
                                                                      {4, 5, 1, 0},
                                                                      {5, 6, 2, 1},
...

        {
...

            {
                ...
                reflected_polyhedron.Vertices =
                    geometryUtilities.RotatePoints(polyhedron_points, reflection_matrix, reflection_translation);
            }

            {
                ...
                const auto reflection_translation = geometryUtilities.PlaneReflectionTranslation(plane_normal, plane_origin);
                reflected_polyhedron.Vertices =
                    geometryUtilities.RotatePoints(reflected_polyhedron.Vertices, reflection_matrix, reflection_translation);
            }

            Eigen::MatrixXd expected_reflected_points(3, 12);
            expected_reflected_points.row(0) << 7.5000000000000000e+00, 5.5000000000000000e+00, 5.5000000000000000e+00,
                7.5000000000000000e+00, 7.5000000000000000e+00, 5.5000000000000000e+00, 5.5000000000000000e+00,
                7.5000000000000000e+00, 7.0000000000000000e+00, 6.0000000000000000e+00, 6.0000000000000000e+00,
                7.0000000000000000e+00;
            expected_reflected_points.row(1) << 1.5000000000000000e+00, 1.5000000000000000e+00, -1.5000000000000000e+00,
                -1.5000000000000000e+00, 1.5000000000000000e+00, 1.5000000000000000e+00, -1.5000000000000000e+00,
                -1.5000000000000000e+00, 7.0000000000000018e-01, 7.0000000000000018e-01, 0.0000000000000000e+00,
                0.0000000000000000e+00;
            expected_reflected_points.row(2) << 0.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00,
                0.0000000000000000e+00, -1.5000000000000000e+00, -1.5000000000000000e+00, -1.5000000000000000e+00,
                -1.5000000000000000e+00, -1.5000000000000000e+00, -1.5000000000000000e+00, -1.5000000000000000e+00,
                -1.5000000000000000e+00;

            ASSERT_TRUE((reflected_polyhedron.Vertices - expected_reflected_points).norm() <=
                        1.0e-15 * expected_reflected_points.norm());
