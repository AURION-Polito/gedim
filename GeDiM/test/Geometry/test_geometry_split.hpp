...
TEST(TestGeometryUtilities, TestSplitPolygonWithSegment)
{
    try
    {
        ...
        // split triangle in a two triangles
        {
            ...
            ASSERT_EQ(result.Type, Gedim::GeometryUtilities::SplitPolygonWithSegmentResult::Types::PolygonCreation);
            ASSERT_EQ(result.NewVertices.size(), 1);
            ASSERT_EQ(result.NewVertices.front().Type,
                      Gedim::GeometryUtilities::SplitPolygonWithSegmentResult::NewVertex::Types::SegmentOrigin);
            ASSERT_EQ(result.NewEdges.size(), 3);
            auto newEdgeIter = result.NewEdges.begin();
            ASSERT_EQ(newEdgeIter->Type, Gedim::GeometryUtilities::SplitPolygonWithSegmentResult::NewEdge::Types::EdgeNew);
            ASSERT_EQ(newEdgeIter->OldEdgeId, 0);
...
TEST(TestGeometryUtilities, TestSplitPolygonWithCircle)
{
    try
    {
        ...
        // circle outside and no intersection
        {
            ...
            Gedim::GeometryUtilities::PolygonCirclePositionTypes polygonPosition =
            ...
            Gedim::GeometryUtilities::SplitPolygonWithCircleResult result =
                geometryUtilities.SplitPolygonWithCircle(polygonVertices, circleCenter, circleRadius, vertexPositions, polygonCircleIntersections, polygonPosition);
        ...
        // Circle Outside Polygon Intersects With Multiple SubPolygons
        {
            ...
            ASSERT_EQ(result.NewVertices[0].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewVertex::Types::PolygonVertex);
            ASSERT_EQ(result.NewVertices[0].PolygonIndex, 0);
            ASSERT_EQ(result.NewVertices[1].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewVertex::Types::PolygonVertex);
            ASSERT_EQ(result.NewVertices[1].PolygonIndex, 1);
            ASSERT_EQ(result.NewVertices[2].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewVertex::Types::CircleIntersection);
            ASSERT_EQ(result.NewVertices[2].IntersectionIndex, 0);
            ASSERT_EQ(result.NewVertices[3].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewVertex::Types::CircleIntersection);
            ASSERT_EQ(result.NewVertices[3].IntersectionIndex, 1);
            ASSERT_EQ(result.NewVertices[4].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewVertex::Types::PolygonVertex);
            ASSERT_EQ(result.NewVertices[4].PolygonIndex, 2);
            ASSERT_EQ(result.NewVertices[5].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewVertex::Types::CircleIntersection);
            ...
            ASSERT_EQ(result.NewEdges[1].ArcType,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::ArcTypes::OutsidePolygon);
            ...
            ASSERT_EQ(result.NewEdges[4].ArcType,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::ArcTypes::InsidePolygon);
            ...
            ASSERT_EQ(result.NewEdges[8].ArcType,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::ArcTypes::InsidePolygon);
            ASSERT_EQ(result.NewEdges[8].VertexIndices, vector<unsigned int>({2, 5}));
            ASSERT_EQ(result.NewPolygons.size(), 4);
            ASSERT_EQ(result.NewPolygons[0].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewPolygon::Types::InsideOnlyCircle);
            ...
            ASSERT_EQ(result.NewPolygons[1].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewPolygon::Types::InsideOnlyPolygon);
            ...
            ASSERT_EQ(result.NewPolygons[2].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewPolygon::Types::InsideOnlyPolygon);
            ...
            ASSERT_EQ(result.NewPolygons[3].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewPolygon::Types::InsideCircleAndPolygon);
        ...
        // Circle Inside Polygon Intersects With Multiple SubPolygons
        {
            ...
            ASSERT_EQ(result.NewVertices[6].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewVertex::Types::CircleIntersection);
            ...
            ASSERT_EQ(result.NewEdges[2].ArcType,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::ArcTypes::InsidePolygon);
            ...
            ASSERT_EQ(result.NewEdges[7].ArcType,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::ArcTypes::InsidePolygon);
            ...
            ASSERT_EQ(result.NewEdges[10].ArcType,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::ArcTypes::InsidePolygon);
            ...
            ASSERT_EQ(result.NewPolygons[4].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewPolygon::Types::InsideCircleAndPolygon);
        ...
        // Generic intersections with quadrilateral
        {
            ...
            ASSERT_EQ(result.NewVertices[8].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewVertex::Types::CircleIntersection);
            ...
            ASSERT_EQ(result.NewEdges[9].ArcType,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::ArcTypes::OutsidePolygon);
            ...
            ASSERT_EQ(result.NewEdges[11].ArcType,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::ArcTypes::OutsidePolygon);
            ...
            ASSERT_EQ(result.NewEdges[14].ArcType,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::ArcTypes::InsidePolygon);
            ...
            ASSERT_EQ(result.NewPolygons[5].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewPolygon::Types::InsideOnlyPolygon);
            ...
            ASSERT_EQ(result.NewPolygons[6].Type,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewPolygon::Types::InsideCircleAndPolygon);
        ...
        // Circle Outside Polygon Intersects With Multiple SubPolygons
        {
            ...
            ASSERT_EQ(result.NewEdges[5].ArcType,
                      Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::ArcTypes::OutsidePolygon);
