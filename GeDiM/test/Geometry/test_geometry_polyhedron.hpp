...
namespace GedimUnitTesting
{
  ...
  TEST(TestGeometryUtilities, Test_Export_Polyhedron)
  {
    ...
    const vector<Eigen::MatrixXd> polyhedron_faces_vertices = geometryUtilities.PolyhedronFaceVertices(polyhedron.Vertices, polyhedron.Faces);
    ...
    const vector<unsigned int> polyhedron_tetra =
        geometryUtilities.PolyhedronTetrahedronsByFaceTriangulations(polyhedron.Vertices, polyhedron.Faces, polyhedron_faces_triangulation, polyhedron_centroid);

    const vector<Eigen::Vector3d> polyhedron_faces_normal = geometryUtilities.PolyhedronFaceNormals(polyhedron_faces_vertices);
    const vector<Eigen::Vector3d> polyhedron_faces_translation = geometryUtilities.PolyhedronFaceTranslations(polyhedron_faces_vertices);
    const vector<Eigen::Matrix3d> polyhedron_faces_rotation =
        geometryUtilities.PolyhedronFaceRotationMatrices(polyhedron_faces_vertices,
                                                         polyhedron_faces_normal,
                                                         polyhedron_faces_translation);
    const vector<bool> polyhedron_faces_normal_direction =
        geometryUtilities.PolyhedronFaceNormalDirections(polyhedron_faces_vertices,
                                                         polyhedron_centroid,
                                                         polyhedron_faces_normal);

    const vector<Eigen::MatrixXd> polyhedron_faces_rotated_vertices =
        geometryUtilities.PolyhedronFaceRotatedVertices(polyhedron_faces_vertices,
                                                        polyhedron_faces_translation,
                                                        polyhedron_faces_rotation);
    const vector<Eigen::Vector3d> polyhedron_faces_rotated_centroid = geometryUtilities.PolyhedronFaceBarycenter(polyhedron_faces_rotated_vertices);
    const std::vector<std::vector<Eigen::Matrix3d>> polyhedron_faces_rotated_triangulation =
        geometryUtilities.PolyhedronFaceExtractTriangulationPoints(polyhedron_faces_rotated_vertices,
                                                                   polyhedron_faces_triangulation);

    const vector<Eigen::MatrixXd> tetrahedrons =
        geometryUtilities.ExtractTetrahedronPoints(polyhedron.Vertices,
                                                   polyhedron_centroid,
                                                   polyhedron_tetra);
