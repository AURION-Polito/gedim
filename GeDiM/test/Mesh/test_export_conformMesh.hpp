...
TEST(TestExportConformedMesh, TestExportConformedMesh2D)
{
    try
    {
        ...
        // conform of simple 2 points mesh with one segment
        {
            ...
            Gedim::IntersectorMesh2DSegment intersectorMeshSegment(domainMesh, geometryUtilities);

            Gedim::IntersectorMesh2DSegment::IntersectionMesh intersectionMesh;
            intersectorMeshSegment.CreateIntersectionMesh(segmentOrigin, segmentEnd, segmentTangent, segmentBarycenter, segmentLength, intersectionMesh);

            // Create mesh union
            vector<double> curvilinearCoordinatesMesh;
            Gedim::IntersectorMesh2DSegment::ToCurvilinearCoordinates(intersectionMesh, curvilinearCoordinatesMesh);
            Gedim::UnionMeshSegment unionMeshSegment(geometryUtilities);

            Gedim::UnionMeshSegment::UnionMesh unionMesh;
            unionMeshSegment.CreateUnionMesh(curvilinearCoordinatesMesh, curvilinearCoordinatesMesh, unionMesh);

            // Conform the mesh 1D
            Gedim::ConformerMeshSegment conformMeshSegment(geometryUtilities);

            Gedim::ConformerMeshSegment::ConformMesh conformMesh;
            ASSERT_NO_THROW(conformMeshSegment.CreateConformMesh(intersectionMesh, unionMesh, 0, conformMesh));

            // Conform the mesh 2D
            Gedim::ConformerMeshPolygon conformMeshPolygon(geometryUtilities);

            ASSERT_NO_THROW(conformMeshPolygon.CreateConformMesh(segmentOrigin, segmentEnd, segmentTangent, conformMesh, domainMesh));

            // Clean mesh 2D
            Gedim::MeshUtilities meshUtilities;
            Gedim::MeshUtilities::ExtractActiveMeshData extractionData;
            ASSERT_NO_THROW(meshUtilities.ExtractActiveMesh(domainMesh, extractionData));

            // Update mesh 1D with cleaned mesh 2D
            ASSERT_NO_THROW(conformMeshSegment.UpdateWithActiveMesh2D(extractionData, conformMesh));

            // Check missing mesh 2D cell0Ds
            ASSERT_NO_THROW(
                conformMeshSegment.AddMissingMesh2DCell0Ds(segmentOrigin, segmentTangent, segmentSquaredLength, domainMesh, conformMesh));
            ...
            EXPECT_NO_THROW(exporter.Export(exportConfiguration, domainMesh));
        }
    }
...
TEST(TestExportConformedMesh, TestConformComplexMesh2D)
{
    try
    {
...

        {
            ...
            segmentMesh.Points.insert(pair<double, Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>(
                0.0000000000000000e+00,
                Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint()));
            segmentMesh.Points.insert(pair<double, Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>(
                2.7221089123105585e-02,
                Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint()));
            segmentMesh.Points.insert(pair<double, Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>(
                1.5081657587860950e-01,
                Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint()));
            segmentMesh.Points.insert(pair<double, Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>(
                2.0636899211510995e-01,
                Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint()));
            segmentMesh.Points.insert(pair<double, Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>(
                2.2032877240731363e-01,
                Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint()));
            segmentMesh.Points.insert(pair<double, Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>(
                2.7084084009418125e-01,
                Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint()));
            segmentMesh.Points.insert(pair<double, Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>(
                2.8618524662562461e-01,
                Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint()));
            segmentMesh.Points.insert(pair<double, Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>(
                2.9736416870129134e-01,
                Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint()));
            segmentMesh.Points.insert(pair<double, Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>(
                3.5907750767017105e-01,
                Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint()));
            segmentMesh.Points.insert(pair<double, Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>(
                4.0661516876623027e-01,
                Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint()));
            segmentMesh.Points.insert(pair<double, Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>(
                4.3798874569320156e-01,
                Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint()));
            segmentMesh.Points.insert(pair<double, Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>(
                6.6913757867999368e-01,
                Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint()));
            segmentMesh.Points.insert(pair<double, Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>(
            ...
            conformerMeshDomain.CreateConformMesh(segmentOrigin, segmentEnd, segmentTangent, segmentMesh, domainMesh);
