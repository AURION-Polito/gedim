...
TEST(TestPlatonicSolid, TestDualTetrahedron)
{
    ...
    Gedim::MeshMatrices mesh_data;
    Gedim::MeshMatricesDAO mesh(mesh_data);
    meshUtilities.Mesh3DFromPolyhedron(dual.Vertices,
                                       dual.Edges,
                                       dual.Faces,
                                       vertexMarkers,
                                       edgeMarkers,
...

    {
        ...
        //  original polyhedron
        vtpUtilities.AddPolyhedron(dual.Vertices,
                                   dual.Edges,
                                   dual.Faces);


        vtpUtilities.Export(exportFolder + "/Dual.vtu",
                            Gedim::VTKUtilities::Ascii);
    }
}
...
TEST(TestPlatonicSolid, TestGeodesicPolyhedron)
{
    ...
    {
        const Gedim::PlatonicSolid platonicSolid(geometryUtilities,
                                                 meshUtilities);
        ...
        // Export to VTK
        {
            ...
            vtpUtilities.Export(exportFolder + "/Geodesic_Tetrahedron_" + to_string(i) + ".vtu",
                                Gedim::VTKUtilities::Ascii);
        }
    ...
    for(unsigned int i = 1; i < 8; i++)
    {
        ...
        // Export to VTK
        {
            ...
            vtpUtilities.Export(exportFolder + "/Geodesic_Icosahedron_" + to_string(i) + ".vtu",
                                Gedim::VTKUtilities::Ascii);
        }
...
TEST(TestPlatonicSolid, TestGoldbergPolyhedron)
{
    ...
    for(unsigned int i = 1; i < 8; i++)
    {
        ...
        // Export to VTK
        {
            ...
            vtpUtilities.Export(exportFolder + "/Goldberg_Tetrahedron_" + to_string(i) + ".vtu",
                                Gedim::VTKUtilities::Ascii);
        }
