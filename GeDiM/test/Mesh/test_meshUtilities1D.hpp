...
TEST(TestMeshUtilities, Test_CollapseCell1D_Mesh2D_Triangle)
{
    std::string exportFolder = "./Export/TestMeshUtilities/Test_CollapseCell1D_Mesh2D_Triangle";
    Gedim::Output::CreateFolder(exportFolder);
...

    {
      ...
      mesh_utilities.CreateTriangularMesh(square,
                                         0.1,
                                         mesh);
    }
