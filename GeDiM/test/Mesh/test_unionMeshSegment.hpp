...
TEST(TestUnionMeshSegment, TestUnionMeshSegment)
{
    try
    {
        ...
        // unify simple two points mesh
        {
            ...
            meshOne.Points.insert(pair<double, Gedim::IntersectorMesh2DSegment::IntersectionMesh::IntersectionMeshPoint>(
                0.0,
            ...
            meshTwo.Points.insert(pair<double, Gedim::IntersectorMesh2DSegment::IntersectionMesh::IntersectionMeshPoint>(
                0.0,
                Gedim::IntersectorMesh2DSegment::IntersectionMesh::IntersectionMeshPoint()));
            meshTwo.Points.insert(pair<double, Gedim::IntersectorMesh2DSegment::IntersectionMesh::IntersectionMeshPoint>(
                1.0,
            ...
            ASSERT_NO_THROW(UnionMeshSegment.CreateUnionMesh(curvilinearCoordinatesMeshOne, curvilinearCoordinatesMeshTwo, result));

            EXPECT_EQ(result.Points.size(), 2);
            EXPECT_EQ(result.Points[0.0000000000000000e+00].Type,
                      Gedim::UnionMeshSegment::UnionMesh::UnionMeshPoint::UnionMeshPoint::Types::Both);
            ...
            EXPECT_EQ(result.Points[1.0000000000000000e+00].Type,
                      Gedim::UnionMeshSegment::UnionMesh::UnionMeshPoint::UnionMeshPoint::Types::Both);
        ...
        // unify four points mesh with four points mesh
        {
            ...
            EXPECT_EQ(result.Points[0.0000000000000000e+00].MeshIndices[0], 0);
            EXPECT_EQ(result.Points[0.0000000000000000e+00].MeshIndices[1], 0);
            EXPECT_EQ(result.Points[2.5000000000000000e-01].Type,
                      Gedim::UnionMeshSegment::UnionMesh::UnionMeshPoint::UnionMeshPoint::Types::First);
            ...
            EXPECT_EQ(result.Points[5.0000000000000000e-01].Type,
                      Gedim::UnionMeshSegment::UnionMesh::UnionMeshPoint::UnionMeshPoint::Types::Both);
            ...
            EXPECT_EQ(result.Points[7.5000000000000000e-01].Type,
                      Gedim::UnionMeshSegment::UnionMesh::UnionMeshPoint::UnionMeshPoint::Types::Second);
