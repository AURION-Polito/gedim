...
{
// ***************************************************************************
list<vector<int>> Utilities::CombinationWithRepetition(int n, int k)
{
    n--;
    vector<int> v(k + 1, 0);
...
// ***************************************************************************
std::vector<unsigned int> Utilities::RandomArrayNoRepetition(const unsigned int &n, const unsigned int &maxNumber, const unsigned int &seed)
{
    if (n == 0)
        return {};
