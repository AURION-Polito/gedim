...
// ***************************************************************************
template <typename Eigen_ArrayType, typename Eigen_SparseArrayType, typename Eigen_SolverType>
void Eigen_PCGSolver<Eigen_ArrayType, Eigen_SparseArrayType, Eigen_SolverType>::Initialize(const IArray &rightHandSide,
                                                                                           IArray &solution,
                                                                                           const Configuration &configuration)
{
    _rightHandSide = &rightHandSide;
...
// ***************************************************************************
template <typename Eigen_ArrayType, typename Eigen_SparseArrayType, typename Eigen_SolverType>
ILinearSolver::SolutionInfo Eigen_PCGSolver<Eigen_ArrayType, Eigen_SparseArrayType, Eigen_SolverType>::Solve() const
{
...
// ***************************************************************************
template <typename Eigen_ArrayType, typename Eigen_SparseArrayType, typename Eigen_SolverType>
ILinearSolver::SolutionInfo Eigen_PCGSolver<Eigen_ArrayType, Eigen_SparseArrayType, Eigen_SolverType>::Solve(const IArray &rightHandSide,
