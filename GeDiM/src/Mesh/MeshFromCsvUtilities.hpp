...
class MeshFromCsvUtilities final
{
  ...
  private:
    ...
    vector<CellDoubleProperty::Value> ImportCellProperty(IFileReader &csvFileReader, const char &separator) const;
  ...
  public:
    ...
    /// \param cell0Ds the container of cell0Ds
    /// \param mesh the mesh
    void ConvertCell0Ds(const vector<MeshFromCsvUtilities::Cell0D> cell0Ds, IMeshDAO &mesh) const;
    /// \brief Convert the imported Cell1Ds to mesh
    /// \param cell1Ds the container of cell1Ds
    /// \param mesh the mesh
    void ConvertCell1Ds(const vector<MeshFromCsvUtilities::Cell1D> cell1Ds, IMeshDAO &mesh) const;
    /// \brief Convert the imported Cell2Ds to mesh
    /// \param cell2Ds the container of cell2Ds
    /// \param mesh the mesh
    void ConvertCell2Ds(const vector<MeshFromCsvUtilities::Cell2D> cell2Ds, IMeshDAO &mesh) const;
    /// \brief Convert the imported Cell3Ds to mesh
    /// \param cell3Ds the container of cell3Ds
    /// \param mesh the mesh
    void ConvertCell3Ds(const vector<MeshFromCsvUtilities::Cell3D> cell3Ds, IMeshDAO &mesh) const;

    /// \brief Convert the imported Cell0D neighbours to mesh
    /// \param cell0DNeighbours the container of cell0D neighbours
    /// \param mesh the mesh
    void ConvertCell0DNeighbours(const vector<MeshFromCsvUtilities::Cell0DNeighbours> cell0DNeighbours, IMeshDAO &mesh) const;
    /// \brief Convert the imported Cell1D neighbours to mesh
    /// \param cell1DNeighbours the container of cell1D neighbours
    /// \param mesh the mesh
    void ConvertCell1DNeighbours(const vector<MeshFromCsvUtilities::Cell1DNeighbours> cell1DNeighbours, IMeshDAO &mesh) const;
    /// \brief Convert the imported Cell2D neighbours to mesh
    /// \param cell2DNeighbours the container of cell2D neighbours
    /// \param mesh the mesh
    void ConvertCell2DNeighbours(const vector<MeshFromCsvUtilities::Cell2DNeighbours> cell2DNeighbours, IMeshDAO &mesh) const;

    /// \brief Convert the imported Cell2D subdivision to mesh
    /// \param cell2DSubDivisions the container of cell2D neighbours
    /// \param mesh the mesh
    void ConvertCell2DSubDivisions(const vector<MeshFromCsvUtilities::Cell2DSubDivision> cell2DSubDivisions, IMeshDAO &mesh) const;
    ...
    /// \param mesh the mesh
    void ConvertCell0DUpdatedCells(const vector<MeshFromCsvUtilities::CellUpdatedCells> cell0DUpdatedCells, IMeshDAO &mesh) const;
    /// \brief Convert the imported Cell1D updated cells to mesh
    /// \param cell1DUpdatedCells the container of cell1D updated cells
    /// \param mesh the mesh
    void ConvertCell1DUpdatedCells(const vector<MeshFromCsvUtilities::CellUpdatedCells> cell1DUpdatedCells, IMeshDAO &mesh) const;
    /// \brief Convert the imported Cell2D updated cells to mesh
    /// \param cell2DUpdatedCells the container of cell2D updated cells
    /// \param mesh the mesh
    void ConvertCell2DUpdatedCells(const vector<MeshFromCsvUtilities::CellUpdatedCells> cell2DUpdatedCells, IMeshDAO &mesh) const;
    /// \brief Convert the imported Cell3D updated cells to mesh
    /// \param cell3DUpdatedCells the container of cell3D updated cells
    /// \param mesh the mesh
    void ConvertCell3DUpdatedCells(const vector<MeshFromCsvUtilities::CellUpdatedCells> cell3DUpdatedCells, IMeshDAO &mesh) const;

    /// \brief Import Cell0Ds; format: Id, Marker, Active, X, Y, Z
    /// \param csvFileReader the file reader
    /// \param separator the file separator
    /// \param mesh the mesh to be Imported
    vector<Cell0D> ImportCell0Ds(IFileReader &csvFileReader, const char &separator) const;
    /// \brief Import Cell1Ds; format: Id, Marker, Active, Origin, End
    /// \param csvFileReader the file reader
    /// \param separator the file separator
    vector<Cell1D> ImportCell1Ds(IFileReader &csvFileReader, const char &separator) const;
    /// \brief Import Cell2Ds; format: Id, Marker, Active, NumVertices, Vertices, NumEdges, Edges
    /// \param csvFileReader the file reader
    /// \param separator the file separator
    vector<Cell2D> ImportCell2Ds(IFileReader &csvFileReader, const char &separator) const;
    /// \brief Import Cell3Ds; format: Id, Marker, Active, NumVertices, Vertices, NumEdges, Edges, NumFaces, Faces
    /// \param csvFileReader the file reader
    /// \param separator the file separator
    vector<Cell3D> ImportCell3Ds(IFileReader &csvFileReader, const char &separator) const;
    ...
    vector<Cell0DNeighbours> ImportCell0DNeighbours(IFileReader &csvFileReader, const char &separator) const;
    /// \brief Import Cell1DNeighbours; format: Id, Num2DNeighbours, 2DNeighbours, Num3DNeighbours, 3DNeighbours
    /// \param csvFileReader the file reader
    /// \param separator the file separator
    vector<Cell1DNeighbours> ImportCell1DNeighbours(IFileReader &csvFileReader, const char &separator) const;

    /// \brief Import Cell2DNeighbours; format: Id, Num3DNeighbours, 3DNeighbours
    /// \param csvFileReader the file reader
    /// \param separator the file separator
    vector<Cell2DNeighbours> ImportCell2DNeighbours(IFileReader &csvFileReader, const char &separator) const;

    /// \brief Import Cell2DSubDivision; format: Id, NumSubDivision, SubDivisions
    /// \param csvFileReader the file reader
    /// \param separator the file separator
    vector<Cell2DSubDivision> ImportCell2DSubDivision(IFileReader &csvFileReader, const char &separator) const;

    /// \brief Import CellProperties; format: Id, FilePath
    /// \param csvFileReader the file reader
    /// \param separator the file separator
    vector<CellDoubleProperty> ImportCellDoubleProperties(IFileReader &csvFileReader, const char &separator) const;

    /// \brief Import CellUpdatedCells; format: Id, NumUpdatedCells, UpdatedCells
    /// \param csvFileReader the file reader
    /// \param separator the file separator
    vector<CellUpdatedCells> ImportCellUpdatedCells(IFileReader &csvFileReader, const char &separator) const;

    /// \brief Export Cell0Ds; format: Id, Marker, Active, X, Y, Z
    /// \param filePath the path of the file
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell0Ds(const string &filePath, const char &separator, const IMeshDAO &mesh) const;
    /// \brief Export Cell1Ds; format: Id, Marker, Active, Origin, End
    /// \param filePath the path of the file
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell1Ds(const string &filePath, const char &separator, const IMeshDAO &mesh) const;
    /// \brief Export Cell2Ds; format: Id, Marker, Active, NumVertices, Vertices, NumEdges, Edges
    /// \param filePath the path of the file
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell2Ds(const string &filePath, const char &separator, const IMeshDAO &mesh) const;
    /// \brief Export Cell3Ds; format: Id, Marker, Active, NumVertices, Vertices, NumEdges, Edges, NumFaces, Faces
    /// \param filePath the path of the file
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell3Ds(const string &filePath, const char &separator, const IMeshDAO &mesh) const;
    ...
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell0DProperty(const unsigned int &propertyIndex, const string &filePath, const char &separator, const IMeshDAO &mesh) const;
    ...
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell1DProperty(const unsigned int &propertyIndex, const string &filePath, const char &separator, const IMeshDAO &mesh) const;
    ...
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell2DProperty(const unsigned int &propertyIndex, const string &filePath, const char &separator, const IMeshDAO &mesh) const;
    ...
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell3DProperty(const unsigned int &propertyIndex, const string &filePath, const char &separator, const IMeshDAO &mesh) const;
    ...
    void ExportCell0DNeighbours(const string &filePath, const char &separator, const IMeshDAO &mesh) const;
    /// \brief Export Cell1DNeighbours; format: Id, Num2DNeighbours, 2DNeighbours, Num3DNeighbours, 3DNeighbours
    /// \param filePath the path of the file
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell1DNeighbours(const string &filePath, const char &separator, const IMeshDAO &mesh) const;
    /// \brief Export Cell2DNeighbours; format: Id, Num3DNeighbours, 3DNeighbours
    /// \param filePath the path of the file
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell2DNeighbours(const string &filePath, const char &separator, const IMeshDAO &mesh) const;
    /// \brief Export Cell2DSubDivisions; format: Id, NumSubDivision, SubDivisions
    /// \param filePath the path of the file
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell2DSubDivisions(const string &filePath, const char &separator, const IMeshDAO &mesh) const;

    /// \brief Export Cell0DUpdatedCells; format: Id, NumUpdatedCells, UpdatedCells
    /// \param filePath the path of the file
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell0DUpdatedCells(const string &filePath, const char &separator, const IMeshDAO &mesh) const;
    /// \brief Export Cell1DUpdatedCells; format: Id, NumUpdatedCells, UpdatedCells
    /// \param filePath the path of the file
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell1DUpdatedCells(const string &filePath, const char &separator, const IMeshDAO &mesh) const;
    /// \brief Export Cell2DUpdatedCells; format: Id, NumUpdatedCells, UpdatedCells
    /// \param filePath the path of the file
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell2DUpdatedCells(const string &filePath, const char &separator, const IMeshDAO &mesh) const;
    /// \brief Export Cell3DUpdatedCells; format: Id, NumUpdatedCells, UpdatedCells
    /// \param filePath the path of the file
    /// \param separator the file separator
    /// \param mesh the mesh to be exported
    void ExportCell3DUpdatedCells(const string &filePath, const char &separator, const IMeshDAO &mesh) const;
};
