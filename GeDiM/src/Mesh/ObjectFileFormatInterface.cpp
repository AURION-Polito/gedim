...
std::vector<string> ObjectFileFormatInterface::OFFMeshToStrings(const OFFMesh &mesh) const
{
    ...
    lines.push_back(std::to_string(mesh.NumCell0Ds) + " " + std::to_string(mesh.NumCell2Ds) + " " + std::to_string(mesh.NumCell1Ds));
...
// ***************************************************************************
void ObjectFileFormatInterface::OFFMeshToMeshDAO(const OFFMesh &originalMesh, const MeshUtilities &meshUtilities, IMeshDAO &convertedMesh) const
{
...
// ***************************************************************************
void ObjectFileFormatInterface::ImportMeshFromFile(const std::string &offFilePath, const MeshUtilities &meshUtilities, IMeshDAO &mesh) const
{
    ...
    OFFMeshToMeshDAO(meshImported, meshUtilities, mesh);
}
// ***************************************************************************
void ObjectFileFormatInterface::ExportMeshToFile(const IMeshDAO &mesh, const std::string &offFilePath) const
{
