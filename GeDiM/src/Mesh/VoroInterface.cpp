                  ...
                  if (neighbor.neighbors[n_f] == static_cast<int>(cell3DIndex))
                  {
                    ...
                    if(face.vertices.size() != num_face_vertices)
                    {

                      {
                        ...
                        {
                          Eigen::MatrixXd neigh_cell_vertices_coordinates = Eigen::MatrixXd::Zero(3, neighbor.vertices.size());
                        ...
                        {
                          Eigen::MatrixXd neigh_face_vertices_coordinates = Eigen::MatrixXd::Zero(3, face.vertices.size());
