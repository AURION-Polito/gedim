...
struct MeshMatrices final
{
    ...
    std::vector<unsigned int> NumberCell0DNeighbourCell1D = {0}; ///< Cell0D neighbour Cell1D indices per cell, size  1
                                                                 ///< x NumberCell0D + 1
    std::vector<unsigned int> Cell0DNeighbourCell1Ds = {};       ///< Cell0D neighbour Cell1D indices, size 1 x
                                                                 ///< NumberCell0DNeighbourCell1D[NumberCell0D]
    std::vector<unsigned int> NumberCell0DNeighbourCell2D = {0}; ///< Cell0D neighbour Cell2D indices per cell, size  1
                                                                 ///< x NumberCell0D + 1
    std::vector<unsigned int> Cell0DNeighbourCell2Ds = {};       ///< Cell0D neighbour Cell2D indices, size 1 x
                                                                 ///< NumberCell0DNeighbourCell2D[NumberCell0D]
    std::vector<unsigned int> NumberCell0DNeighbourCell3D = {0}; ///< Cell0D neighbour Cell2D indices per cell, size  1
                                                                 ///< x NumberCell0D + 1
    std::vector<unsigned int> Cell0DNeighbourCell3Ds = {};       ///< Cell0D neighbour Cell3D indices, size 1 x
                                                                 ///< NumberCell0DNeighbourCell3D[NumberCell0D]
    std::vector<bool> ActiveCell0D = {};                         ///< active Cell0D
    std::unordered_map<unsigned int, std::unordered_set<unsigned int>> UpdatedCell0Ds = {}; ///< for each cell0D the
                                                                                            ///< list to the new cell0Ds
    std::vector<std::string> Cell0DDoublePropertyIds = {}; ///< Cell0D double property id - double property index
    std::unordered_map<std::string, unsigned int> Cell0DDoublePropertyIndices = {}; ///< Cell0D double property id -
    ...
    std::vector<unsigned int> NumberCell1DNeighbourCell2D = {0}; ///< Cell1D neighbour Cell2D indices per cell, size  1
                                                                 ///< x NumberCell1D + 1
    std::vector<unsigned int> NumberCell1DNeighbourCell3D = {0}; ///< Cell1D neighbour Cell3D indices per cell, size  1
                                                                 ///< x NumberCell1D + 1
    std::vector<unsigned int> Cell1DNeighbourCell2Ds = {};       ///< Cell1D neighbour Cell2D indices, size 1 x
                                                                 ///< NumberCell1DNeighbourCell2D[NumberCell1D]
    std::vector<unsigned int> Cell1DNeighbourCell3Ds = {};       ///< Cell1D neighbour Cell3D indices, size 1 x
    ...
    std::vector<unsigned int> Cell1DOriginalCell1Ds = {};        ///< for each cell1D the index of original cell1D,
                                                          ///< NumberCell1D is the default value (no original cell),
                                                          ///< size 1 x NumberCell1D
    std::unordered_map<unsigned int, std::unordered_set<unsigned int>> UpdatedCell1Ds = {}; ///< for each cell1D the
                                                                                            ///< list to the new cell1Ds
    std::vector<std::string> Cell1DDoublePropertyIds = {}; ///< Cell1D double property id - double property index
    std::unordered_map<std::string, unsigned int> Cell1DDoublePropertyIndices = {}; ///< Cell1D double property id -
                                                                                    ///< double property index
    ...
    std::vector<unsigned int> Cell2DVertices = {};        ///< Cell2D Vertices indices, size 1 x
    ...
    std::vector<unsigned int> NumberCell2DNeighbourCell3D = {0}; ///< Cell2D neighbour Cell3D indices per cell, size  1
                                                                 ///< x NumberCell2D + 1
    std::vector<unsigned int> Cell2DNeighbourCell3Ds = {};       ///< Cell2D neighbour Cell3D indices, size 1 x
    ...
    std::vector<unsigned int> NumberCell2DSubdivision = {0};     ///< number of sub-division per Cell2D, size 1 x
                                                                 ///< NumberCell2D + 1
    std::vector<unsigned int> Cell2DSubdivision = {}; ///< Sub-division of Cell2Ds, used for Concave polygons, size 1 x
                                                      ///< NumberCell2DSubdivision[NumberCell2D]
    std::vector<unsigned int> Cell2DOriginalCell2Ds = {}; ///< for each cell2D the index of original cell2D,
                                                          ///< NumberCell2D is the default value (no original cell),
                                                          ///< size 1 x NumberCell2D
    std::unordered_map<unsigned int, std::unordered_set<unsigned int>> UpdatedCell2Ds = {}; ///< for each cell2D the
                                                                                            ///< list to the new cell2Ds
    std::vector<std::string> Cell2DDoublePropertyIds = {}; ///< Cell2D double property id - double property index
    std::unordered_map<std::string, unsigned int> Cell2DDoublePropertyIndices = {}; ///< Cell2D double property id -
                                                                                    ///< double property index
    ...
    std::vector<unsigned int> Cell3DVertices = {};        ///< Cell3D Cell0D indices, size 1 x
    ...
    std::vector<unsigned int> Cell3DOriginalCell3Ds = {}; ///< for each cell3D the index of original cell3D,
                                                          ///< NumberCell3D is the default value (no original cell),
                                                          ///< size 1 x NumberCell3D
    std::unordered_map<unsigned int, std::unordered_set<unsigned int>> UpdatedCell3Ds = {}; ///< for each cell3D the
                                                                                            ///< list to the new cell3Ds
    std::vector<std::string> Cell3DDoublePropertyIds = {}; ///< Cell3D double property id - double property index
    std::unordered_map<std::string, unsigned int> Cell3DDoublePropertyIndices = {}; ///< Cell3D double property id -
                                                                                    ///< double property index
