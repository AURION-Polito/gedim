...
{
    const auto edge = std::make_pair(MIN(origin, end), MAX(origin, end));
    ...
    edges.insert(std::make_pair(edge, new_edge_id));
                                             ...
                                             std::map<std::pair<unsigned int, unsigned int>, Mesh_Face> &faces) const
{
    ...
    {
        const auto face = std::make_pair(face_edges.at(v), face_vertices.at((v + 2) % 3));
    ...
    Mesh_Face new_face = {Eigen::MatrixXi(2, 3), static_cast<unsigned int>(faces.size()), 1};
    ...
    faces.insert(std::make_pair(std::make_pair(face_edges.at(0), face_vertices.at(2)), new_face));
...
VtkMeshInterface::VtkMesh3D VtkMeshInterface::ComputeVtkMesh3D(VtkMesh &originalMesh) const
{
    ...
    for (unsigned int c = 0; c < originalMesh.NumCell3Ds; c++)
    {
        ...
        cell3D_edges[0] = InsertNewEdge(cell3D_vertices.at(0), cell3D_vertices.at(1), cell1Ds);
        cell3D_edges[1] = InsertNewEdge(cell3D_vertices.at(1), cell3D_vertices.at(2), cell1Ds);
        cell3D_edges[2] = InsertNewEdge(cell3D_vertices.at(2), cell3D_vertices.at(0), cell1Ds);
        cell3D_edges[3] = InsertNewEdge(cell3D_vertices.at(0), cell3D_vertices.at(3), cell1Ds);
        cell3D_edges[4] = InsertNewEdge(cell3D_vertices.at(1), cell3D_vertices.at(3), cell1Ds);
        cell3D_edges[5] = InsertNewEdge(cell3D_vertices.at(2), cell3D_vertices.at(3), cell1Ds);

        cell3D_faces[0] = InsertNewFace({cell3D_vertices.at(0), cell3D_vertices.at(1), cell3D_vertices.at(2)},
                                        {
                                            cell3D_edges.at(0),
                                            cell3D_edges.at(1),
                                            cell3D_edges.at(2),
        ...
        cell3D_faces[1] = InsertNewFace({cell3D_vertices.at(0), cell3D_vertices.at(1), cell3D_vertices.at(3)},
                                        {
                                            cell3D_edges.at(0),
                                            cell3D_edges.at(4),
                                            cell3D_edges.at(3),
        ...
        cell3D_faces[2] = InsertNewFace({cell3D_vertices.at(1), cell3D_vertices.at(2), cell3D_vertices.at(3)},
                                        {
                                            cell3D_edges.at(1),
                                            cell3D_edges.at(5),
                                            cell3D_edges.at(4),
        ...
        cell3D_faces[3] = InsertNewFace({cell3D_vertices.at(2), cell3D_vertices.at(3), cell3D_vertices.at(0)},
                                        {
                                            cell3D_edges.at(5),
                                            cell3D_edges.at(3),
                                            cell3D_edges.at(2),
