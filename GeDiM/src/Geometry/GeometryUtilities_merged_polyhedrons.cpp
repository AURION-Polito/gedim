                                                                                  ...
                                                                                  const bool remove_common_face) const
{
    ...
    // vertices
    result.Vertices_Type[0].resize(poly_one.Vertices.cols(), {MergePolyhedronsInput::MergeTypes::None, MergePolyhedronsInput::none});
    result.Vertices_Type[1].resize(poly_two.Vertices.cols(), {MergePolyhedronsInput::MergeTypes::None, MergePolyhedronsInput::none});

    // edges
    result.Edges_Type[0].resize(poly_one.Edges.cols(), {MergePolyhedronsInput::MergeTypes::None, MergePolyhedronsInput::none});
    result.Edges_Type[1].resize(poly_two.Edges.cols(), {MergePolyhedronsInput::MergeTypes::None, MergePolyhedronsInput::none});

    // faces
    result.Faces_Type[0].resize(poly_one.Faces.size(), {MergePolyhedronsInput::MergeTypes::None, MergePolyhedronsInput::none});
    result.Faces_Type[1].resize(poly_two.Faces.size(), {MergePolyhedronsInput::MergeTypes::None, MergePolyhedronsInput::none});
                                                                              ...
                                                                              const MergePolyhedronsInput &merge_information) const
{
    ...
    original_to_merged_vertices_one.resize(poly_one.Vertices.cols(), MergePolyhedronsResult::none);
    original_to_merged_vertices_two.resize(poly_two.Vertices.cols(), MergePolyhedronsResult::none);
    ...
    result.MergedToOriginalVertices =
        std::vector<std::array<unsigned int, 2>>(merged_to_original_vertices.begin(), merged_to_original_vertices.end());
    ...
    original_to_merged_edges_one.resize(poly_one.Edges.cols(), MergePolyhedronsResult::none);
    original_to_merged_edges_two.resize(poly_two.Edges.cols(), MergePolyhedronsResult::none);
    ...
    result.MergedToOriginalEdges =
        std::vector<std::array<unsigned int, 2>>(merged_to_original_edges.begin(), merged_to_original_edges.end());
    ...
    original_to_merged_faces_one.resize(poly_one.Faces.size(), MergePolyhedronsResult::none);
    original_to_merged_faces_two.resize(poly_two.Faces.size(), MergePolyhedronsResult::none);
    ...
    result.MergedToOriginalFaces =
        std::vector<std::array<unsigned int, 2>>(merged_to_original_faces.begin(), merged_to_original_faces.end());
