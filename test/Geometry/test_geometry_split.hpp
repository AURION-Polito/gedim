  ...
  TEST(TestGeometryUtilities, TestSplitPolygonWithCircle)
  {
    try
    {
      ...
      // Circle Outside Polygon Intersects With Multiple SubPolygons
      {
        ...
        ASSERT_EQ(result.NewEdges[1].VertexIndices, vector<unsigned int>({ 1, 2 }));
        ASSERT_EQ(result.NewEdges[2].Type, Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::Types::Segment);
        ASSERT_EQ(result.NewEdges[2].PolygonIndex, 0);
        ASSERT_EQ(result.NewEdges[2].VertexIndices, vector<unsigned int>({ 2, 3 }));
        ...
        ASSERT_EQ(result.NewEdges[4].VertexIndices, vector<unsigned int>({ 2, 4 }));
        ...
        ASSERT_EQ(result.NewEdges[6].Type, Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::Types::Arc);
        ASSERT_EQ(result.NewEdges[6].ArcType, Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::ArcTypes::OutsidePolygon);
        ASSERT_EQ(result.NewEdges[6].VertexIndices, vector<unsigned int>({ 4, 5 }));
        ...
        ASSERT_EQ(result.NewEdges[7].VertexIndices, vector<unsigned int>({ 5, 6 }));
        ...
        ASSERT_EQ(result.NewEdges[9].ArcType, Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::ArcTypes::InsidePolygon);
        ASSERT_EQ(result.NewEdges[9].VertexIndices, vector<unsigned int>({ 5, 7 }));
        ASSERT_EQ(result.NewEdges[10].Type, Gedim::GeometryUtilities::SplitPolygonWithCircleResult::NewEdge::Types::Segment);
        ASSERT_EQ(result.NewEdges[10].PolygonIndex, 2);
        ...
        ASSERT_EQ(result.NewEdges[12].PolygonIndex, 2);
        ...
        ASSERT_EQ(result.NewEdges[14].VertexIndices, vector<unsigned int>({ 0, 8 }));
        ASSERT_EQ(result.NewEdges.size(), 4);
